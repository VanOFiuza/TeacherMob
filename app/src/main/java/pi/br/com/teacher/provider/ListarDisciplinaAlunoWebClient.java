...
public class ListarDisciplinaAlunoWebClient extends AsyncTask<Void, Void, String> {
    ...
    public ListarDisciplinaAlunoWebClient(Context context, MetodoCallback metodoCallback) {
...
//        alertDialog.show();
    ...
    protected String doInBackground(Void... params) {
        ...
        resposta = webClient.post(WebClient.urlServidor + "turma/disciplinas/"+ UsuarioLogado.usuarioLogin.getId(), null, context, "GET");
