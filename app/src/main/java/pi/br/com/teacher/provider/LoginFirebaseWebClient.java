...
public class LoginFirebaseWebClient extends AsyncTask<Void, Void, String> {
    ...
    public LoginFirebaseWebClient(Context context, UsuarioLogin usuarioLogin, String tipo, MetodoCallback metodoCallback) {
    ...
    protected String doInBackground(Void... params) {
        ...
        resposta = webClient.post(WebClient.urlServidor + "login/?userType=" + tipo.toLowerCase(), usuarioLogin.getUsuario(), context, "POST");
    ...
    protected void onPostExecute(String s) {
        ...
        if (resposta.getStatusCode() < 400)
            ...
            Toast.makeText(context, "Disposito com falha na comunicação", Toast.LENGTH_SHORT).show();
